...
import com.example.AddItemPage.AddItem;
import com.example.CategoryPage.Category;
...
public class Dashboard_Activity extends AppCompatActivity {
    ...
    public void AddCategory (View v) {
        Intent addCat = new Intent(this, Category.class);
    ...
    public void GoToItemList (View v) {
     ...
     public void GoToViewItem (View v) {
        Intent ViewItem = new Intent(this, com.example.ViewItemPage.ViewItem.class);
